...
namespace Improbable.SpatialOS.Deployment.V1Beta1
{
    ...
    /// <summary>
    /// Builder class for <see cref="DeploymentServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class DeploymentServiceClientBuilder : gaxgrpc::ClientBuilderBase<DeploymentServiceClient>
    {
        /// <summary>
        /// The settings to use for RPCs, or null for the default settings.
        /// </summary>
        public DeploymentServiceSettings Settings { get; set; }

        /// <inheritdoc/>
        public override DeploymentServiceClient Build()
        {
            Validate();
            grpccore::CallInvoker callInvoker = CreateCallInvoker();
            return DeploymentServiceClient.Create(callInvoker, Settings);
        }

        /// <inheritdoc />
        public override async stt::Task<DeploymentServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => DeploymentServiceClient.DefaultEndpoint;

        /// <inheritdoc />
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => DeploymentServiceClient.DefaultScopes;

        /// <inheritdoc />
        protected override gaxgrpc::ChannelPool GetChannelPool() => DeploymentServiceClient.ChannelPool;
    }
    ...
    public abstract partial class DeploymentServiceClient
    {
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="DeploymentServiceClient"/>, applying defaults for all unspecified settings,
        ...
        /// <returns>The task representing the created <see cref="DeploymentServiceClient"/>.</returns>
        public static async stt::Task<DeploymentServiceClient> CreateAsync(gaxgrpc::ServiceEndpoint endpoint = null, DeploymentServiceSettings settings = null)
        {
        ...
        public static DeploymentServiceClient Create(gaxgrpc::ServiceEndpoint endpoint = null, DeploymentServiceSettings settings = null)
        {
        ...
        /// <summary>
        /// Creates a <see cref="DeploymentServiceClient"/> which uses the specified call invoker for remote operations.
        /// </summary>
        /// <param name="callInvoker">The <see cref="grpccore::CallInvoker"/> for remote operations. Must not be null.</param>
        /// <param name="settings">Optional <see cref="DeploymentServiceSettings"/>.</param>
        /// <returns>The created <see cref="DeploymentServiceClient"/>.</returns>
        public static DeploymentServiceClient Create(grpccore::CallInvoker callInvoker, DeploymentServiceSettings settings = null)
        {
            ...
            DeploymentService.DeploymentServiceClient grpcClient = new DeploymentService.DeploymentServiceClient(callInvoker);
            return new DeploymentServiceClientImpl(grpcClient, settings);
        }

        /// <summary>
        /// Shuts down any channels automatically created by <see cref="Create(gaxgrpc::ServiceEndpoint, DeploymentServiceSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint, DeploymentServiceSettings)"/>. Channels which weren't automatically
        /// created are not affected.
        /// </summary>
        /// <remarks>After calling this method, further calls to <see cref="Create(gaxgrpc::ServiceEndpoint, DeploymentServiceSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint, DeploymentServiceSettings)"/> will create new channels, which could
        ...
        public virtual gax::PagedAsyncEnumerable<ListDeploymentsResponse, Deployment> ListDeploymentsAsync(
            ...
            int? pageSize = null,
            gaxgrpc::CallSettings callSettings = null) => ListDeploymentsAsync(
        ...
        public virtual gax::PagedEnumerable<ListDeploymentsResponse, Deployment> ListDeployments(
            ...
            string pageToken = null,
            int? pageSize = null,
            gaxgrpc::CallSettings callSettings = null) => ListDeployments(
                new ListDeploymentsRequest
                {
                    ProjectName = gax::GaxPreconditions.CheckNotNullOrEmpty(projectName, nameof(projectName)),
                    PageToken = pageToken ?? "",
        ...
        public virtual stt::Task<GetDeploymentResponse> GetDeploymentAsync(
            long id,
            gaxgrpc::CallSettings callSettings = null) => GetDeploymentAsync(
        ...
        public virtual GetDeploymentResponse GetDeployment(
            long id,
            gaxgrpc::CallSettings callSettings = null) => GetDeployment(
                new GetDeploymentRequest
                {
                    Id = id,
                },
        ...
        public virtual stt::Task<GetDeploymentResponse> GetRunningDeploymentByNameAsync(
            ...
            gaxgrpc::CallSettings callSettings = null) => GetRunningDeploymentByNameAsync(
                new GetRunningDeploymentByNameRequest
                {
                    ProjectName = gax::GaxPreconditions.CheckNotNullOrEmpty(projectName, nameof(projectName)),
        ...
        public virtual GetDeploymentResponse GetRunningDeploymentByName(
            string projectName,
            string deploymentName,
            gaxgrpc::CallSettings callSettings = null) => GetRunningDeploymentByName(
                new GetRunningDeploymentByNameRequest
                {
                    ProjectName = gax::GaxPreconditions.CheckNotNullOrEmpty(projectName, nameof(projectName)),
                    DeploymentName = gax::GaxPreconditions.CheckNotNullOrEmpty(deploymentName, nameof(deploymentName)),
        ...
        public virtual stt::Task<lro::Operation<Deployment, CreateDeploymentMetadata>> CreateDeploymentAsync(
            ...
            string deploymentName,
            string assemblyName,
            string startingSnapshotId,
            LaunchConfig launchConfig,
            gaxgrpc::CallSettings callSettings = null) => CreateDeploymentAsync(
                new CreateDeploymentRequest
                {
                    ProjectName = gax::GaxPreconditions.CheckNotNullOrEmpty(projectName, nameof(projectName)),
                    DeploymentName = gax::GaxPreconditions.CheckNotNullOrEmpty(deploymentName, nameof(deploymentName)),
                    AssemblyName = assemblyName ?? "", // Optional
                    StartingSnapshotId = startingSnapshotId ?? "", // Optional
        ...
        public virtual stt::Task<lro::Operation<Deployment, CreateDeploymentMetadata>> CreateDeploymentAsync(
            ...
            string startingSnapshotId,
            LaunchConfig launchConfig,
            st::CancellationToken cancellationToken) => CreateDeploymentAsync(
                projectName,
                deploymentName,
                assemblyName,
                startingSnapshotId,
        ...
        public virtual lro::Operation<Deployment, CreateDeploymentMetadata> CreateDeployment(
            ...
            string startingSnapshotId,
            LaunchConfig launchConfig,
            gaxgrpc::CallSettings callSettings = null) => CreateDeployment(
                new CreateDeploymentRequest
                {
                    ProjectName = gax::GaxPreconditions.CheckNotNullOrEmpty(projectName, nameof(projectName)),
                    DeploymentName = gax::GaxPreconditions.CheckNotNullOrEmpty(deploymentName, nameof(deploymentName)),
        ...
        public virtual stt::Task<lro::Operation<Deployment, DeleteDeploymentMetadata>> DeleteDeploymentAsync(
            long id,
            gaxgrpc::CallSettings callSettings = null) => DeleteDeploymentAsync(
                new DeleteDeploymentRequest
                {
                    Id = id,
                },
                callSettings);
        ...
        public virtual stt::Task<lro::Operation<Deployment, DeleteDeploymentMetadata>> DeleteDeploymentAsync(
            long id,
            st::CancellationToken cancellationToken) => DeleteDeploymentAsync(
                id,
                gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        public virtual lro::Operation<Deployment, DeleteDeploymentMetadata> DeleteDeployment(
            long id,
            gaxgrpc::CallSettings callSettings = null) => DeleteDeployment(
                new DeleteDeploymentRequest
                {
                    Id = id,
                },
        ...
        public virtual stt::Task<lro::Operation<Deployment, RestartDeploymentMetadata>> RestartDeploymentAsync(
            long? id,
            gaxgrpc::CallSettings callSettings = null) => RestartDeploymentAsync(
                new RestartDeploymentRequest
                {
                    Id = id ?? 0L, // Optional
                },
                callSettings);
        ...
        public virtual stt::Task<lro::Operation<Deployment, RestartDeploymentMetadata>> RestartDeploymentAsync(
            long? id,
            st::CancellationToken cancellationToken) => RestartDeploymentAsync(
                id,
                gaxgrpc::CallSettings.FromCancellationToken(cancellationToken));
        ...
        public virtual lro::Operation<Deployment, RestartDeploymentMetadata> RestartDeployment(
            long? id,
            gaxgrpc::CallSettings callSettings = null) => RestartDeployment(
                new RestartDeploymentRequest
                {
                    Id = id ?? 0L, // Optional
                },
        ...
        public virtual stt::Task<SetDeploymentWorkerFlagsResponse> SetDeploymentWorkerFlagsAsync(
            long deploymentId,
            scg::IEnumerable<WorkerFlag> workerFlags,
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentWorkerFlagsAsync(
                new SetDeploymentWorkerFlagsRequest
                {
                    DeploymentId = deploymentId,
                    WorkerFlags = { gax::GaxPreconditions.CheckNotNull(workerFlags, nameof(workerFlags)) },
                },
                callSettings);
        ...
        public virtual SetDeploymentWorkerFlagsResponse SetDeploymentWorkerFlags(
            long deploymentId,
            scg::IEnumerable<WorkerFlag> workerFlags,
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentWorkerFlags(
                new SetDeploymentWorkerFlagsRequest
                {
                    DeploymentId = deploymentId,
                    WorkerFlags = { gax::GaxPreconditions.CheckNotNull(workerFlags, nameof(workerFlags)) },
        ...
        public virtual stt::Task<SetDeploymentTagsResponse> SetDeploymentTagsAsync(
            long deploymentId,
            scg::IEnumerable<string> tags,
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentTagsAsync(
                new SetDeploymentTagsRequest
                {
                    DeploymentId = deploymentId,
                    Tags = { gax::GaxPreconditions.CheckNotNull(tags, nameof(tags)) },
                },
                callSettings);
        ...
        public virtual SetDeploymentTagsResponse SetDeploymentTags(
            long deploymentId,
            scg::IEnumerable<string> tags,
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentTags(
                new SetDeploymentTagsRequest
                {
                    DeploymentId = deploymentId,
                    Tags = { gax::GaxPreconditions.CheckNotNull(tags, nameof(tags)) },
        ...
        ///
        /// </param>
        /// <param name="workerConnectionCapacities">
        ///
        /// </param>
        /// <param name="callSettings">
        /// If not null, applies overrides to this RPC call.
        ...
        public virtual stt::Task<SetDeploymentWorkerCapacitiesResponse> SetDeploymentWorkerCapacitiesAsync(
            long deploymentId,
            scg::IEnumerable<WorkerCapacity> workerConnectionCapacities,
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentWorkerCapacitiesAsync(
                new SetDeploymentWorkerCapacitiesRequest
                {
                    DeploymentId = deploymentId,
                    WorkerConnectionCapacities = { gax::GaxPreconditions.CheckNotNull(workerConnectionCapacities, nameof(workerConnectionCapacities)) },
                },
                callSettings);
        ...
        public virtual SetDeploymentWorkerCapacitiesResponse SetDeploymentWorkerCapacities(
            long deploymentId,
            scg::IEnumerable<WorkerCapacity> workerConnectionCapacities,
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentWorkerCapacities(
                new SetDeploymentWorkerCapacitiesRequest
                {
                    DeploymentId = deploymentId,
                    WorkerConnectionCapacities = { gax::GaxPreconditions.CheckNotNull(workerConnectionCapacities, nameof(workerConnectionCapacities)) },
        ...
        ///
        /// </param>
        /// <param name="workerConnectionRateLimits">
        ///
        /// </param>
        /// <param name="callSettings">
        /// If not null, applies overrides to this RPC call.
        ...
        public virtual stt::Task<SetDeploymentWorkerRateLimitsResponse> SetDeploymentWorkerRateLimitsAsync(
            long deploymentId,
            scg::IEnumerable<WorkerRateLimit> workerConnectionRateLimits,
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentWorkerRateLimitsAsync(
                new SetDeploymentWorkerRateLimitsRequest
                {
                    DeploymentId = deploymentId,
                    WorkerConnectionRateLimits = { gax::GaxPreconditions.CheckNotNull(workerConnectionRateLimits, nameof(workerConnectionRateLimits)) },
                },
                callSettings);
        ...
        public virtual SetDeploymentWorkerRateLimitsResponse SetDeploymentWorkerRateLimits(
            long deploymentId,
            scg::IEnumerable<WorkerRateLimit> workerConnectionRateLimits,
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentWorkerRateLimits(
                new SetDeploymentWorkerRateLimitsRequest
                {
                    DeploymentId = deploymentId,
                    WorkerConnectionRateLimits = { gax::GaxPreconditions.CheckNotNull(workerConnectionRateLimits, nameof(workerConnectionRateLimits)) },
