    ...
    public abstract partial class DeploymentServiceClient
    {
        ...
        public virtual stt::Task<SetDeploymentTagsResponse> SetDeploymentTagsAsync(
            ...
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentTagsAsync(
                new SetDeploymentTagsRequest
                {
                    ...
                    Tags = { tags ?? linq::Enumerable.Empty<string>() }, // Optional
                },
                callSettings);
        ...
        public virtual stt::Task<SetDeploymentWorkerCapacitiesResponse> SetDeploymentWorkerCapacitiesAsync(
            ...
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentWorkerCapacitiesAsync(
                ...
                {
                    DeploymentId = deploymentId,
                    WorkerConnectionCapacities = { workerConnectionCapacities ?? linq::Enumerable.Empty<WorkerCapacity>() }, // Optional
                },
                callSettings);
        ...
        public virtual stt::Task<SetDeploymentWorkerFlagsResponse> SetDeploymentWorkerFlagsAsync(
            ...
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentWorkerFlagsAsync(
                ...
                {
                    DeploymentId = deploymentId,
                    WorkerFlags = { workerFlags ?? linq::Enumerable.Empty<WorkerFlag>() }, // Optional
                },
                callSettings);
        ...
        public virtual stt::Task<SetDeploymentWorkerRateLimitsResponse> SetDeploymentWorkerRateLimitsAsync(
            ...
            gaxgrpc::CallSettings callSettings = null) => SetDeploymentWorkerRateLimitsAsync(
                ...
                {
                    DeploymentId = deploymentId,
                    WorkerConnectionRateLimits = { workerConnectionRateLimits ?? linq::Enumerable.Empty<WorkerRateLimit>() }, // Optional
                },
                callSettings);
        ...
        public virtual stt::Task<StopDeploymentResponse> StopDeploymentAsync(
            string projectName,
            string id,
            gaxgrpc::CallSettings callSettings = null) => StopDeploymentAsync(
        ...
        public virtual StopDeploymentResponse StopDeployment(
            string projectName,
            string id,
            gaxgrpc::CallSettings callSettings = null) => StopDeployment(
                new StopDeploymentRequest
                {
                    ProjectName = gax::GaxPreconditions.CheckNotNullOrEmpty(projectName, nameof(projectName)),
                    Id = gax::GaxPreconditions.CheckNotNullOrEmpty(id, nameof(id)),
        ...
        public virtual stt::Task<UpdateDeploymentResponse> UpdateDeploymentAsync(
            ...
            gaxgrpc::CallSettings callSettings = null) => UpdateDeploymentAsync(
        ...
        public virtual UpdateDeploymentResponse UpdateDeployment(
            Deployment deployment,
            pbwkt::FieldMask updateMask,
            gaxgrpc::CallSettings callSettings = null) => UpdateDeployment(
                new UpdateDeploymentRequest
                {
                    Deployment = gax::GaxPreconditions.CheckNotNull(deployment, nameof(deployment)),
                    UpdateMask = gax::GaxPreconditions.CheckNotNull(updateMask, nameof(updateMask)),
