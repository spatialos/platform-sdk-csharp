...
namespace Improbable.SpatialOS.RemoteInteraction.V1Alpha1
{
    ...
    public sealed partial class RemoteInteractionServiceSettings : gaxgrpc::ServiceSettingsBase
    {
        ...
        /// <summary>
        /// The filter specifying which RPC <see cref="grpccore::StatusCode"/>s are eligible for retry
        /// for "NonIdempotent" <see cref="RemoteInteractionServiceClient"/> RPC methods.
        /// </summary>
        /// <remarks>
    ...
    /// <summary>
    /// Builder class for <see cref="RemoteInteractionServiceClient"/> to provide simple configuration of credentials, endpoint etc.
    /// </summary>
    public sealed partial class RemoteInteractionServiceClientBuilder : gaxgrpc::ClientBuilderBase<RemoteInteractionServiceClient>
    {
        /// <summary>
        /// The settings to use for RPCs, or null for the default settings.
        /// </summary>
        public RemoteInteractionServiceSettings Settings { get; set; }

        /// <inheritdoc/>
        public override RemoteInteractionServiceClient Build()
        {
            Validate();
            grpccore::CallInvoker callInvoker = CreateCallInvoker();
            return RemoteInteractionServiceClient.Create(callInvoker, Settings);
        }

        /// <inheritdoc />
        public override async stt::Task<RemoteInteractionServiceClient> BuildAsync(st::CancellationToken cancellationToken = default)
        {
            Validate();
        ...
        /// <inheritdoc />
        protected override gaxgrpc::ServiceEndpoint GetDefaultEndpoint() => RemoteInteractionServiceClient.DefaultEndpoint;

        /// <inheritdoc />
        protected override scg::IReadOnlyList<string> GetDefaultScopes() => RemoteInteractionServiceClient.DefaultScopes;

        /// <inheritdoc />
        protected override gaxgrpc::ChannelPool GetChannelPool() => RemoteInteractionServiceClient.ChannelPool;
    }
    ...
    public abstract partial class RemoteInteractionServiceClient
    {
        ...
        /// <summary>
        /// Asynchronously creates a <see cref="RemoteInteractionServiceClient"/>, applying defaults for all unspecified settings,
        ...
        /// <returns>The task representing the created <see cref="RemoteInteractionServiceClient"/>.</returns>
        public static async stt::Task<RemoteInteractionServiceClient> CreateAsync(gaxgrpc::ServiceEndpoint endpoint = null, RemoteInteractionServiceSettings settings = null)
        {
        ...
        public static RemoteInteractionServiceClient Create(gaxgrpc::ServiceEndpoint endpoint = null, RemoteInteractionServiceSettings settings = null)
        {
        ...
        /// <summary>
        /// Creates a <see cref="RemoteInteractionServiceClient"/> which uses the specified call invoker for remote operations.
        /// </summary>
        /// <param name="callInvoker">The <see cref="grpccore::CallInvoker"/> for remote operations. Must not be null.</param>
        /// <param name="settings">Optional <see cref="RemoteInteractionServiceSettings"/>.</param>
        /// <returns>The created <see cref="RemoteInteractionServiceClient"/>.</returns>
        public static RemoteInteractionServiceClient Create(grpccore::CallInvoker callInvoker, RemoteInteractionServiceSettings settings = null)
        {
            ...
            RemoteInteractionService.RemoteInteractionServiceClient grpcClient = new RemoteInteractionService.RemoteInteractionServiceClient(callInvoker);
            return new RemoteInteractionServiceClientImpl(grpcClient, settings);
        }

        /// <summary>
        /// Shuts down any channels automatically created by <see cref="Create(gaxgrpc::ServiceEndpoint, RemoteInteractionServiceSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint, RemoteInteractionServiceSettings)"/>. Channels which weren't automatically
        /// created are not affected.
        /// </summary>
        /// <remarks>After calling this method, further calls to <see cref="Create(gaxgrpc::ServiceEndpoint, RemoteInteractionServiceSettings)"/>
        /// and <see cref="CreateAsync(gaxgrpc::ServiceEndpoint, RemoteInteractionServiceSettings)"/> will create new channels, which could
